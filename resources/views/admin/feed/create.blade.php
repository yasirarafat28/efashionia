  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div id="service-categories">
        ...
        <div class="form-group required">
          ...
          <div class="col-sm-6">
            <select name="mode" class="form-control" id="package_id">
              ...
              <option value="insert">New Insert(will merge)</option>
              <option value="replace">Update(will delete previous entries)</option>
            </select>
          </div>
        </div>

        <div class="form-group required">
          <label class="col-sm-2 control-label" for="input-zone">File Type</label>
          <div class="col-sm-6">
            <select name="file_type" class="form-control" id="package_id">
        ...
        <div class="form-group required">
          <label class="col-sm-2 control-label" for="input-zone">Feed File</label>
          <div class="col-sm-6">
